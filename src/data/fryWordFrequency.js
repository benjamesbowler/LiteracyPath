// Frequency ranks only; the reviewed HFW bank still controls word eligibility.
// Fry rank order, checked 2026-09-14 against the CSUSB College of Education list:
// https://coe.csusb.edu/sites/default/files/Frys1000InstantWordsquickchecklist%20(1).pdf
// Cross-check for ranks 1-600: https://www.uen.org/earlylearning/word_lists.shtml
// Correct the source's typos in day, interest and dollars; keep its rank order.
export const FRY_WORD_FREQUENCY = Object.freeze([
  ...
  "building", "ocean", "class", "note", "nothing", "rest", "carefully", "scientist", "inside", "wheels",
  ...
  "window", "difference", "distance", "heart", "sit", "sum", "summer", "wall", "forest", "probably",
  ...
  "record", "finished", "discovered", "wild", "happy", "beside", "gone", "sky", "glass", "million",
  ...
  "temperature", "bright", "lead", "everyone", "method", "section", "lake", "consonant", "within", "dictionary",
  "hair", "age", "amount", "scale", "pounds", "although", "per", "broken", "moment", "tiny",
  "possible", "gold", "milk", "quiet", "natural", "lot", "stone", "act", "build", "middle",
  "speed", "count", "cat", "someone", "sail", "rolled", "bear", "wonder", "smiled", "angle",
  "fraction", "africa", "killed", "melody", "bottom", "trip", "hole", "poor", "let's", "fight",
  "surprise", "french", "died", "beat", "exactly", "remain", "dress", "iron", "couldn't", "fingers",
  "row", "least", "catch", "climbed", "wrote", "shouted", "continued", "itself", "else", "plains",
  "gas", "england", "burning", "design", "joined", "foot", "law", "ears", "grass", "you're",
  ...
  "gun", "similar", "death", "score", "forward", "stretched", "experienced", "rose", "allow", "fear",
