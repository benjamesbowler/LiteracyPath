...
const RPCS = new Set(
  "admin_error_monitor_summary admin_get_school_retention_policy admin_list_deletion_propagation admin_preview_school_retention admin_recent_error_events admin_review_assessment_question_report admin_run_school_retention admin_save_school_retention_policy admin_set_teacher_account_status admin_verify_deletion_propagation find_or_create_school get_game_leaderboard guardian_accept_invite guardian_get_portal guardian_invite_preview guardian_record_report_event guardian_update_preferences report_app_error report_assessment_question search_school_names set_app_config student_class_by_code student_get_live_lesson student_get_progress student_get_reading_session student_list_press_projects student_log_activity_v2 student_login student_read_class_press_library student_report_activity_sync_health student_save_book_revision student_save_progress student_submit_book_revision student_submit_live_response teacher_assign_instructional_group_follow_up teacher_cancel_guardian_invite teacher_cancel_intervention teacher_class_access_log teacher_class_access_summary teacher_close_worksheet_instance teacher_complete_learner_deletion teacher_create_demo_class teacher_create_guardian_invite teacher_create_insight_intervention teacher_create_intervention_follow_up teacher_create_intervention_plan teacher_create_lesson_plan teacher_create_press_project teacher_create_worksheet_instance teacher_delete_empty_class teacher_delete_learner_data_staged teacher_delete_planned_intervention teacher_delete_saved_assessment_report teacher_end_live_lesson teacher_end_reading_session teacher_export_learner_data teacher_get_active_live_lesson teacher_get_learner_deletion_status teacher_get_live_lesson_snapshot teacher_get_reading_session_presence teacher_list_guardian_access teacher_list_learner_data_rights teacher_list_press_work teacher_mark_intervention_delivered teacher_prepare_learner_deletion teacher_read_lesson_plan teacher_read_worksheet_history teacher_record_insight_observation teacher_record_intervention_outcome teacher_record_lesson_delivery teacher_record_worksheet_observation teacher_regenerate_class_code teacher_release_family_report teacher_reset_student_progress teacher_resolve_worksheet_code teacher_review_book_revision teacher_review_instructional_group teacher_review_intervention teacher_revoke_guardian_access teacher_save_instructional_group teacher_save_reading_marks teacher_set_class_code_expiry teacher_set_class_leaderboard_scope teacher_set_live_lesson_slide teacher_set_reading_session_page teacher_set_school teacher_set_student_archived teacher_set_student_symbol_password teacher_start_live_lesson teacher_start_reading_session teacher_transfer_student teacher_update_draft_lesson_plan teacher_update_planned_intervention teacher_withdraw_family_report".split(" ")
);
