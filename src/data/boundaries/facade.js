const TABLES = new Set(
  "activity_sync_health answers app_admins app_config assessment_attempts assessment_question_reports assessment_sessions classes el_assessment_reports guided_reading_book_reviews item_mastery mastery pending_teacher_accounts reading_sessions schools student_progress students teacher_account_decision_events teacher_instructional_group_reviews teacher_instructional_groups teacher_intervention_events teacher_interventions worksheet_bank".split(" ")
);
const RPCS = new Set(
  "admin_error_monitor_summary admin_get_school_retention_policy admin_list_deletion_propagation admin_preview_school_retention admin_recent_error_events admin_review_assessment_question_report admin_run_school_retention admin_save_school_retention_policy admin_set_teacher_account_status admin_verify_deletion_propagation find_or_create_school get_game_leaderboard list_school_names report_app_error report_assessment_question set_app_config student_class_by_code student_get_progress student_get_reading_session student_log_activity_v2 student_login student_report_activity_sync_health student_save_progress teacher_assign_instructional_group_follow_up teacher_cancel_intervention teacher_class_access_log teacher_class_access_summary teacher_complete_learner_deletion teacher_create_demo_class teacher_create_insight_intervention teacher_create_intervention_follow_up teacher_create_intervention_plan teacher_delete_empty_class teacher_delete_learner_data_staged teacher_delete_planned_intervention teacher_delete_saved_assessment_report teacher_end_reading_session teacher_export_learner_data teacher_get_learner_deletion_status teacher_get_reading_session_presence teacher_list_learner_data_rights teacher_mark_intervention_delivered teacher_prepare_learner_deletion teacher_record_insight_observation teacher_record_intervention_outcome teacher_regenerate_class_code teacher_reset_student_progress teacher_review_instructional_group teacher_review_intervention teacher_save_instructional_group teacher_save_reading_marks teacher_set_class_code_expiry teacher_set_class_leaderboard_scope teacher_set_reading_session_page teacher_set_school teacher_set_student_archived teacher_set_student_symbol_password teacher_start_reading_session teacher_transfer_student teacher_update_planned_intervention".split(" ")
);
