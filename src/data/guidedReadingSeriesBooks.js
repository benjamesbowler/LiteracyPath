...
const createAidenPage = ({ bookNumber, pageNumber, text, illustrationPrompt, narrationNeedsRebuild = false }) => ({
  pageNumber,
  text: normalizeReadingText(text),
...
const createAidenAndBettyBook = ({
  ...
  imageGenerationReference:
    "Keep Aiden, Betty, and Socks the small brown-and-white dog consistent across the Level C series. Use the source page text and prompt for each page; no non-diegetic embedded text, captions, or page numbers.",
  expectedStoryPageCount: pages.length,
  availableStoryPageCount: pages.length,
  missingStoryPages: [],
...
export const guidedReadingSeriesBooks = [
  ...
  createAidenAndBettyBook({
    ...
    pages: [
      ...
      { pageNumber: 9, text: `After lunch came reading. Miss Okafor gave them word puzzles with story clues. Each one was a little harder than the last. Aiden's brain felt stretched in a new way. He discovered that this was not a bad feeling.`, illustrationPrompt: "Aiden concentrating on a reading puzzle with story clues.", narrationNeedsRebuild: true },
  ...
  createAidenAndBettyBook({
    ...
    pages: [
      ...
      { pageNumber: 13, text: `The drive home felt half as long as the drive there, which Aiden thought was impossible. When they turned into their street, the house looked completely the same as when they'd left it. Aiden noticed he felt, quietly, like he was a little bit different.`, illustrationPrompt: "Aiden and Betty arriving home after their holiday." }
    ]
  }),
  createAidenAndBettyBook({
    id: "ab-c-04",
    ...
    bookNumber: 4,
    theme: "meeting Socks the foster dog",
  ...
  createAidenAndBettyBook({
    ...
    pages: [
      ...
      { pageNumber: 12, text: `That evening, Aiden added a new page to his field notebook. He wrote down six things that make an experiment fair and safe. Socks sat beside the desk and watched his pen move, which Aiden had never seen him do before.`, narrationNeedsRebuild: true },
  ...
  createAidenAndBettyBook({
    ...
    pages: [
      ...
      { pageNumber: 6, text: `Socks had other interests. He reached the start of a wide wooden footbridge over the river before anyone had finished the sentence. Aiden wanted to follow. Uncle Eddie checked the map and clipped on Socks's lead. Then they crossed together.`, narrationNeedsRebuild: true },
      { pageNumber: 7, text: `The far bank was different — thicker trees, softer ground, a field of tall meadow grass beyond the treeline. Socks trotted ahead on his long lead, turning back every few steps to make sure they were following.`, narrationNeedsRebuild: true },
      { pageNumber: 8, text: `He led them to a shallow pool in a mossy clearing — fed by a spring, perfectly clear and still. Two dragonflies skimmed the surface, electric blue. Aiden crouched at the path's edge and looked in while Socks waited beside him. Small things moved in the shallows.`, narrationNeedsRebuild: true },
      { pageNumber: 9, text: `Back at the hide, Betty wrote down every species she could identify in the visitor log book. Uncle Eddie checked the names with her. She made neat entries for dragonflies, water boatmen and a great diving beetle.`, narrationNeedsRebuild: true },
  ...
  createDinoPalsBook({
    ...
    pages: [
      ...
      { pageNumber: 6, text: `Sneezy sneezed. Leaves, berries, and Bossy's planning clipboard flew through the air.`, narrationNeedsRebuild: true },
