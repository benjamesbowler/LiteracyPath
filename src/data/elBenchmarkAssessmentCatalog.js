...
/**
 * Named decoding bands and cycle anchors from the supplied overview.  The
 * early-full entry is a documented Grade 1 range entry; the overview does not
 * assign it one exact cycle, so `anchorCycle` is intentionally null instead of
 * inventing a value.
 */
