 ...
 */
export default function ActivityButton({ onClick, disabled, children, style, ...props }) {
  ...
  return <button {...props} ref={button} disabled={disabled} style={{ ...style, touchAction: 'none' }}
    onPointerDown={event => {
