...
const CODE_SPOT_WORD_INVENTORY = Object.freeze({
  ...
  th: { authorizedFromCycle: 15, sort: ["thumb", "thin", "three"], transfer: [{ word: "then", fits: true }, { word: "ship", fits: false }] },
  ...
  ang: { authorizedFromCycle: 23, sort: ["bang", "sang"], transfer: [{ word: "fang", fits: true }, { word: "sing", fits: false }] },
  ...
  ung: { authorizedFromCycle: 23, sort: ["sung", "rung"], transfer: [{ word: "lung", fits: true }, { word: "song", fits: false }] },
  ff: { authorizedFromCycle: 24, sort: ["off", "huff"], transfer: [{ word: "huff", fits: true }, { word: "miss", fits: false }] },
  ss: { authorizedFromCycle: 24, sort: ["miss", "grass"], transfer: [{ word: "kiss", fits: true }, { word: "off", fits: false }] },
...
export const ADVENTURE_WORD_BUILD_INVENTORY = Object.freeze([
  ...
  { word: "three", graphemes: ["th", "r", "ee"], authorizedFromCycle: 15 },
  ...
  { word: "sung", graphemes: ["s", "u", "ng"], authorizedFromCycle: 23 },
  { word: "off", graphemes: ["o", "ff"], authorizedFromCycle: 24 },
...
const TAUGHT_PATTERN_REVIEW_INVENTORY = Object.freeze([
  ...
  },
  {
    ...
    members: ["ring", "king", "song", "bang", "fang", "long"],
