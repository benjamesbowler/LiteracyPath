  ...
  return (
    ...
    >
      ...
      {!ceremony && <nav className="qp-dpad" aria-label="Move your Beastie">
        <button type="button" onPointerDown={() => runtimeRef.current?.move("up")} aria-label="Move up"><span aria-hidden="true">&#8593;</span></button>
        <button type="button" onPointerDown={() => runtimeRef.current?.move("left")} aria-label="Move left"><span aria-hidden="true">&#8592;</span></button>
        <button type="button" onPointerDown={() => runtimeRef.current?.move("down")} aria-label="Move down"><span aria-hidden="true">&#8595;</span></button>
        <button type="button" onPointerDown={() => runtimeRef.current?.move("right")} aria-label="Move right"><span aria-hidden="true">&#8594;</span></button>
      </nav>}
