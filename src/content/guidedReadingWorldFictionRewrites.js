...
export const GUIDED_READING_WORLD_FICTION_REWRITES = Object.freeze({
  ...
  "dino-pals-16-chompy-and-grumpys-day-out": fictionRewrite({
    ...
    pages: [
      ...
      "Grumpy settles into the perfect quiet spot.",
  ...
  "moonwood-tales-c-06": fictionRewrite({
    ...
    pages: [
      ...
      "Flint sits. A perfect map of yesterday cannot guide today.",
  ...
  "moonwood-tales-c-07": fictionRewrite({
    ...
    pages: [
      ...
      "The fish circles slowly. Being new made it want a grand past.",
  ...
  "moonwood-tales-c-11": fictionRewrite({
    ...
    pages: [
      ...
      "Stone kneels. \"I am large, so I will call carefully.\"",
  ...
  "moonwood-tales-c-13": fictionRewrite({
    ...
    pages: [
      ...
      "Glimmer replaces the charts with one feeling: warm breath, released slowly.",
