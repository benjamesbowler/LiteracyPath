// Saved-progress validation uses receipt structure and the shared placement
// definitions. Full expedition/catalogue authority belongs to coverageStatus.
import { CONTENT_DECK_PLACEMENT_SPECS as CONTENT_DECK_PLACEMENTS } from "../content/contentDeckPlacementSpecs.js";
import {
...
export function normalizeContentUseState(raw) {
