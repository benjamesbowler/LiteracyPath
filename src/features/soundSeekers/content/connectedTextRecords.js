...
const ASSESSED_CONTENT = [
  ["s1", "Wake the Seed Lanterns", "Lift mat; see light.", "What uncovers Moss's seed light?", ["lift", "mat", "see", "light"], [["a", "Lift light."], ["b", "Lift mat."], ["c", "Lift mats."]], [["lift", 0, "new_concept"], ["see", 2, "new_concept"], ["light", 3, "new_concept"]], [["ct-s1-a", "lift", 0, "new_concept"], ["ct-s1-a", "light", 1, "new_concept"], ["ct-s1-b", "lift", 0, "new_concept"], ["ct-s1-c", "lift", 0, "new_concept"]]],
  ["s2", "Rebuild the Fern-Step Song", "Fit fin; sit at mat.", "What mends Tumble's fern step?", "sit", [["a", "Fit fin."], ["b", "Sit at fin."], ["c", "Fan fin."]]],
  ["s3", "Turn the Rook Wind Stones", "Hit the hot rock drum.", "What starts Bramble's wind-stone drum?", ["hot", "rock", "drum"], [["a", "Sit on rock."], ["b", "Hit hot hat."], ["c", "Hit hot rock."]], [["rock", 3, "new_concept"], ["drum", 4, "new_concept"]], [["ct-s3-a", "rock", 2, "new_concept"], ["ct-s3-c", "rock", 2, "new_concept"]]],
  ["s4", "Raise the Otter Ford", "Not bun; rock in gap.", "What fills Tumble's ford gap?", ["rock", "gap", "bun"], [["a", "Bun in gap."], ["b", "Rock in gap."], ["c", "Rock on gap."]], [["rock", 2, "new_concept"], ["gap", 4, "new_concept"]], [["ct-s4-a", "gap", 2, "new_concept"], ["ct-s4-b", "rock", 0, "new_concept"], ["ct-s4-b", "gap", 2, "new_concept"], ["ct-s4-c", "rock", 0, "new_concept"], ["ct-s4-c", "gap", 2, "new_concept"]]],
  ["s6", "Guide the Bluff Bees Home", "Get the buzz box home.", "How can Fizz guide the bluff bees home?", ["buzz", "box", "home"], [["a", "Get net home."], ["b", "Get van home."], ["c", "Get box home."]], [["buzz", 2, "new_concept"], ["home", 4, "new_concept"]], [["ct-s6-a", "home", 2, "new_concept"], ["ct-s6-b", "home", 2, "new_concept"], ["ct-s6-c", "home", 2, "new_concept"]]],
  ["s7", "Relaunch the Lily Ferry", "Get jam off the bell.", "What frees Quill's ferry brake bell?", "jam", [["a", "Get jam off bell."], ["b", "Get bell off mat."], ["c", "Get jam on bell."]]],
  ["s8", "Clear Fishpool Reach", "Not mat; cut the net.", "What clears Rill's fishpool channel?", "mat", [["a", "Fix net."], ["b", "Cut net."], ["c", "Cut bell."]]],
  ["s9", "Mend Wheelhouse Bend", "Fix the ship fin; it can spin.", "What turns Fizz's water wheel?", ["ship", "spin"], [["a", "Fix fish fin."], ["b", "Sit at ship."], ["c", "Fix ship fin."]], [["spin", 6, "new_concept"]]],
  ["s11", "Raise the Amber Trail Markers", "Pick the rock off the path.", "What reveals Rook's amber path?", "rock", [["a", "Pick rock off path."], ["b", "Kick rock on path."], ["c", "Sit on path rock."]]],
  ["s12", "Rebuild the Rattlebones Lift", "Fit lamp in lift with hand.", "What mends Amber's loose lift part?", ["hand", "lift"], [["a", "Lift lamp."], ["b", "Fit ship lamp."], ["c", "Fit lamp in lift."]]],
  ["s13", "Reveal the Ash-Flat Trail", "Spin the fan; it can clear the path.", "What blows Claw's ash off the trail?", ["spin", "clear"], [["a", "Sit at fan."], ["b", "Spin fan."], ["c", "Hit fan."]], [["clear", 5, "new_concept"]]],
  ["s14", "Bridge Fern Canyon", "Clap at the flag; the path can grow.", "What grows Rook's fern bridge?", ["clap", "grow"], [["a", "Clap at flag."], ["b", "Flip flag."], ["c", "Clap at block."]], [["grow", 7, "new_concept"]]],
  ["s16", "Unlock Gearworks Gate", "Click lock by gate; it can lift.", "Which action opens Bolt's lane?", ["by", "gate"], [["a", "Click flag."], ["b", "Click lock."], ["c", "Fly by lock."]], [["gate", 3, "new_concept"]]],
  ["s17", "Restart the Ore Hopper", "Big rock is in the bin. Lift the rock off.", "What clears Soot's hopper bin?", ["rock", "lift"], [["a", "Kick rock in."], ["b", "Sit on rock."], ["c", "Lift rock off."]]],
  ["s18", "Relight the Plate Foundry", "Cake is hot, but the flame is not hot. Make the flame hot.", "What relights Bellows's foundry?", ["cake", "hot"], [["a", "Make flame hot."], ["b", "Make cake hot."], ["c", "Make plate hot."]]],
  ["s19", "Release the Night Train", "The bike is on the train path. Slide the bike off.", "What clears Bolt's night-train track?", ["bike", "train"], [["a", "Hide bike."], ["b", "Slide bike off."], ["c", "Ride bike."]], [["train", 5, "new_concept"]]],
  ["s21", "Moor the Reedlight Ferry", "The big cube can stop the ship. Fit the rope on the cube.", "What anchors Ripple's drifting ferry?", "cube", [["a", "Rope on mule."], ["b", "Rope on gate."], ["c", "Rope on cube."]]],
  ["s22", "Clear Ripple Pool", "Rain is the theme. Pick rain to start it.", "Which sign starts Mica's clear-water pump?", ["rain", "start", "theme"], [["a", "Pick rain."], ["b", "Pick run."], ["c", "Pick flame."]], [["rain", 0, "new_concept"], ["rain", 5, "new_concept"], ["start", 7, "new_concept"]], [["ct-s22-a", "rain", 1, "new_concept"]]],
  ["s23", "Raise the Mica Steps", "Lift the rain tray. It can lift the path.", "What raises Glint's hidden steps?", ["rain", "lift"], [["a", "Lift train."], ["b", "Lift rain tray."], ["c", "Sit by tray."]]],
  ["s24", "Tune Glint Causeway", "The tree can sing. Clap with tree; the path can sing.", "What tunes Ripple's causeway song?", "tree", [["a", "Sing with tree."], ["b", "Sit by tree."], ["c", "Clap with tree."]]],
  ["s26", "Secure Galecliff Path", "Show coat on the right road. The boat can go that way.", "Which marker keeps Kelp's boat on course?", "boat", [["a", "Show coat on road."], ["b", "Show snow on road."], ["c", "Show goat on road."]]],
  ["s27", "Rebuild Shellhaven Roof", "Snow is in the room. Glue on the blue moon coat to stop it.", "What covers Boom's shelter?", "moon", [["a", "Glue food coat."], ["b", "Glue blue moon coat."], ["c", "Snow on room."]]],
  ["s28", "Restore Signal Harbour", "The book is the light plan. Hook light high so boat can go.", "How can Prism relight the harbour signal?", ["book", "light"], [["a", "Hook book on boat."], ["b", "Hide light in book."], ["c", "Hook light high."]]],
  ["s29", "Calm Stormglass Cove", "The loud sound is in the box. The lid is off. Close the lid on the box.", "What makes Kelp's stormglass box calm?", "sound", [["a", "Close lid on box."], ["b", "Bang on box."], ["c", "Make sound loud."]]],
  ["s31", "Open Mothlight Gate", "The star can lift the gate. Park the car on the star.", "What opens Luma's mothlight gate?", "car", [["a", "Start car at gate."], ["b", "Park car on star."], ["c", "Hide car at farm."]]],
  ["s32", "Wake the Echo Roots", "The storm hit the tree. The light is off. Draw a star on the tree; the light can turn on.", "What wakes Wisp's echo-root light?", ["light", "turn", "storm"], [["a", "Saw tree."], ["b", "Store star."], ["c", "Draw star on tree."]], [["turn", 18, "new_concept"]]],
  ...
  ["s34", "Align Orbit Hollow", "The chair is by one ring. The stair is by the last ring. Pair the chair with the stair.", "Which markers line up Luma's hollow rings?", "chair", [["a", "Pair chair with hair."], ["b", "Pair chair with stair."], ["c", "Pair stair with hair."]]],
  ["s36", "Raise Comet Stair", "The creature is here. Pure light can lift the dark stair. Make the stair bright with pure light so the path is secure.", "What raises Comet's faded stair?", "pure", [["a", "Follow creature."], ["b", "Stair still dark."], ["c", "Make stair bright."]]],
  ["s37", "Open Aster Archive", "Magic words from the city are ready. The lock is dark. Read the magic words at the lock so it can click.", "What opens Aster's archive?", "city", [["a", "Read magic words."], ["b", "Climb city cell."], ["c", "Rest by lock."]]],
  ...
  ["s39", "Complete Reading Skybridge", "The bridge is not complete. The little puzzle can fit in its gap. Fit the little puzzle in the gap.", "What completes Comet's skybridge?", "little", [["a", "Leave puzzle by table."], ["b", "Fit rocks in gap."], ["c", "Fit little puzzle in gap."]]]
];
