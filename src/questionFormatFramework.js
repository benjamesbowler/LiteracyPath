...
function normalizeFormatType(value) {
  ...
  if (type.startsWith("HFW_SENTENCE_CLOZE") || type.startsWith("HFW_SENTENCE_SPELL")) return type;
...
export function requiresAudioSupport(question) {
  ...
  if (["LISTENING", "PTD", "MPD", "PICTURE_TO_PRINT_MATCH", "HEARD_WORD_TO_PRINT_MINIMAL_PAIR", "IMAGE_INITIAL_SOUND", "INITIAL_SOUND_PAIR_SELECT", "FINAL_SOUND_PAIR_SELECT", "RHYME_PAIR_SELECT", "LISTEN_FIND_RHYME", "LISTEN_CHOOSE_VOWEL", "PICTURE_AUDIO_TO_PATTERN", "LISTEN_FIND_WORD", "HFW_AUDIO_FIND_WORD", "PICTURE_TO_PRINT_CVC", "IMAGE_VOWEL_SORT", "SHORT_VOWEL_IMAGE_GROUP_SELECT", "FIRST_SOUND", "ENDING_SOUND", "BLEND_SOUNDS", "PUT_SOUNDS_IN_ORDER", "RHYMING_PICTURE", "SHORT_VOWEL_WORD", "COMPLETE_WORD"].includes(formatType)) return true;
