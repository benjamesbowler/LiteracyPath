...
export function MathsTeacherWorkspace({ mode = "overview", className = "", studentCount = null, classId = "", students = [], client, teacherId, onNavigate }) {
  return <main className="maths-teacher-workspace maths-teacher-workspace-v2" data-maths-teacher-mode={mode}><Header className={className} mode={mode} studentCount={studentCount} />{mode === "overview" && <Overview onNavigate={onNavigate} studentCount={studentCount} />}{mode === "assessments" && <CheckLauncher onNavigate={onNavigate} />}{mode === "resources" && <ResourceLibrary classId={classId} client={client} students={students} />}{mode === "present" && <Presentation />}{mode === "worksheets" && <WorksheetStudio />}{mode === "reports" && <Reports classId={classId} client={client} onNavigate={onNavigate} students={students} />}{mode === "groups" && <SmallGroups classId={classId} client={client} students={students} teacherId={teacherId} />}</main>;
}
