...
Cohesion: 0.13
Nodes (19): getListenAndFindAssetDiagnostics(), getQuestionCards(), getQuestionPrompt(), getStageIndex(), hasCompleteInitialSoundPairAssets(), hasCompletePairSelectionAssets(), hasCompleteVisualQuestionAssets(), hasLowQualityPluralDistractors() (+11 more)

### Community 72 - "StudentHomePage.jsx"
Cohesion: 0.33
Nodes (5): RewardsPage(), DEN_THEMES, denSeenKey(), markRewardsSeen(), newRewardsSinceLastVisit()
...
Cohesion: 0.29
Nodes (7): applyItemMetadata(), findPatternInText(), getItemMasteryStateKeyForValues(), getQuestionAnswer(), inferItemMetadata(), isFixSentenceQuestion(), normalizeItemKey()
