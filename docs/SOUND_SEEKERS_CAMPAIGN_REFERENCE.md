# Retained Sound Seekers campaign reference

## Authority and implementation

This records the campaign before the owner-authorized woodland replacement on
15 September 2026. It is retained for reusable content, artwork, mechanics and
progress compatibility, not as the live presentation or future visual direction.
The [current release Bible](SOUND_SEEKERS_RELEASE_BIBLE.md) owns the live route.
Descriptions of the current campaign below refer to this retained version.

The former child route mounted `v3/SoundSeekersCampaign.jsx`. Its retained owners are:
