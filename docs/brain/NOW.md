...
- The approved new Sound Seekers direction is the rounded 3D woodland adventure with simple 2D/2.5D activities. Its [woodland chapter](../../demos/sound-seekers/CHAPTER_ONE.md) is implemented and pushed at `45ec44c04`: five projects, 15 visits, 120 rounds, five interaction families, branching, exact per-project resume and a complete homecoming. Full development and packaged browser journeys, replay and media recovery were checked. The original five-minute design demo remains an active comparison. The 30–40-minute target still needs observed child play, human listening and physical iPad verification; the full 20-hour campaign remains a later production goal. The chapter has a separate entry and local save, and has not replaced the classroom route.
- The existing classroom Sound Seekers route retains three worlds, 30 stages, 150 main missions, 60 optional quests and eight playable Pals. Branching landscapes now use compass guidance, an obstacle-aware follow camera and explicit nearby activity entry; completed activities remain in Pause replay. Related platform problems preserve the camera, position and construction, with shorter teaching rooms, raised sound stones and animated crossings. Maze actions carry/return objects. Forty-eight illustrated action poses supplement walking cycles. Initial anchors use m → map. Recorded teaching and puzzle directions start automatically, with a circular replay control and picture buttons paired with short text labels; the main lightbulb models the current task directly. Sound practice retains canonical picture clues, marked as picture-supported after loading; teaching pictures stay until the learner advances. Pause retains assisted navigation and text support. Shared speech plans cover every current mission without speaking hidden reading answers; heard credit requires completed playback, and saved mute preferences remain respected. The [release Bible](../SOUND_SEEKERS_RELEASE_BIBLE.md) owns current behaviour, media and verification boundaries. Local browser checks cover all three worlds, activity entry, maze completion/replay, saved help and small-screen controls; later-world fixtures remain synthetic. Former corridor-time estimates are superseded and twenty hours remains unmeasured.
