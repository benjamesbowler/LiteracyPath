...
| --- | --- | --- | --- | --- |
| Sound Seekers woodland chapter | Handoff | `demos/sound-seekers`, chapter preview and supporting project notes | The [approved new chapter](../../demos/sound-seekers/CHAPTER_ONE.md) is pushed at `45ec44c04` and completed full development/packaged playthroughs. Preserve its rounded 3D visual direction, independent save and original demo comparison. The full 20-hour campaign, child-paced duration, human listening and physical iPad evidence remain open. The existing classroom runtime/progress lane below remains separate. | `01a09e5a-4fcc-7a01-89bd-da54748ebb39` |
