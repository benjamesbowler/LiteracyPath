...
| fish | public/audio/child-mode/words/fish.mp3 | fish | word | required | standard | yes | no | CVC and Short Vowels, Final Sounds, Initial Sounds, Rhyming, Sentence Comprehension, Short Vowel Discrimination | ENDING_SOUND, FINAL_SOUND_PAIR_SELECT, FIRST_SOUND, INITIAL_SOUND_PAIR_SELECT, LISTEN_FIND_RHYME, PUT_SOUNDS_IN_ORDER, READ_FIND_RHYME, RHYME_PAIR_SELECT, SENTENCE_MATCHES_PICTURE, SHORT_VOWEL_WORD |
| gate | public/audio/child-mode/words/gate.mp3 | gate | word | required | standard | yes | no | Initial Sounds | INITIAL_SOUND_PAIR_SELECT |
| gum | public/audio/child-mode/words/gum.mp3 | gum | word | required | standard | yes | no | Final Sounds, Initial Sounds | ENDING_SOUND, FINAL_SOUND_PAIR_SELECT, INITIAL_SOUND_PAIR_SELECT |
| hand | public/audio/child-mode/words/hand.mp3 | hand | word | required | standard | yes | no | Final Sounds, Initial Sounds | ENDING_SOUND, FIRST_SOUND, INITIAL_SOUND_PAIR_SELECT |
...
| tiger | public/audio/child-mode/words/tiger.mp3 | tiger | word | required | standard | yes | no | Final Sounds, Initial Sounds | ENDING_SOUND, INITIAL_SOUND_PAIR_SELECT |
...
| van | public/audio/child-mode/words/van.mp3 | van | word | required | standard | yes | no | Initial Sounds, Rhyming | FIRST_SOUND, INITIAL_SOUND_PAIR_SELECT, RHYME_PAIR_SELECT |
| vase | public/audio/child-mode/words/vase.mp3 | vase | word | required | standard | yes | no | Initial Sounds | INITIAL_SOUND_PAIR_SELECT |
| worm | public/audio/child-mode/words/worm.mp3 | worm | word | required | standard | yes | no | Initial Sounds | INITIAL_SOUND_PAIR_SELECT |
