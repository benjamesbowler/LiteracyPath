...
- [Sound Seekers release bible](SOUND_SEEKERS_RELEASE_BIBLE.md) — current three-world campaign with third-person landscapes, segmented platform/maze activities, illustrated sprites, onset teaching anchors and touch controls, formative evidence, media provenance and verification boundaries
