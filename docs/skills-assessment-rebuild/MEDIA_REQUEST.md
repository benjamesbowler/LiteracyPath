...
Generated 2026-07-30T04:42:21.373Z by `tools/assessmentRebuild/gate.mjs`. Regenerate after any bank change — never edit by hand. Machine-readable copy: `MEDIA_REQUEST.json`.
...
1. **Audio for everything.** Recorded human audio (or approved premium TTS), child-friendly voice, natural full sentences, no isolated phonemes, no robotic notation:
   - **Instruction/prompt audio** for every item (`spokenPrompt`) — including instructions, 80 unique lines.
   - **Sentence audio** (41 lines) and **passage read-aloud** (0 passages).
   - **Word audio** for every choice/target word: 129 unique words.
...
|---|---|---|---|---|---|
| homophones_homonyms | 80 | 80 | 304 | 0 | 0 |
