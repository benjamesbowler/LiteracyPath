...
|---|---|---|
| Instruction/prompt lines | 1891 | 0 |
| Sentence read-alouds | 615 | 0 |
| Passage read-alouds | 256 | 0 |
| Single-word recordings | 1555 | 0 |
| Phrase recordings | 1159 | 0 |
| Image slots | 1773 | 0 |
...
0 of 1555 are missing — record the missing set below; the rest already exist in the pool.
...
All 1773 image slots resolve to existing art on disk. Any NEW art must follow the image spec above.
