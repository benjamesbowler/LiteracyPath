...
The first image is a visual candidate, not an approval. It uses the Moonwood
painterly direction and keeps MOON-PIP small beside the much larger MOON-STONE.
