...
|---:|---|---|---|---|
| 1 | a | ant | ant | as requested |
| 2 | a | astronaut | astronaut | as requested |
| 1 | b | bat | bat | as requested |
| 2 | b | banana | banana | as requested |
| 1 | c | cat | cat | as requested |
| 2 | c | crayon | calculator | substituted because requested word "crayon" is not in Level 2 bank |
| 1 | d | dog | dog | as requested |
| 2 | d | doctor | doctor | as requested |
| 1 | e | egg | egg | as requested |
| 2 | e | elephant | elevator | substituted because requested word "elephant" is not in Level 2 bank |
| 1 | f | fan | fan | as requested |
| 2 | f | fish | firefighter | substituted because requested word "fish" is not in Level 2 bank |
| 1 | g | gun | gum | substituted because requested word "gun" is not in Level 1 bank |
| 2 | g | girl | gorilla | substituted because requested word "girl" is not in Level 2 bank |
| 1 | h | hat | hat | as requested |
| 2 | h | hospital | hospital | as requested |
| 1 | i | ink | ink | as requested |
| 2 | i | igloo | iceberg | substituted because requested word "igloo" is not in Level 2 bank |
| 1 | j | jam | jam | as requested |
| 2 | j | jellyfish | jellyfish | as requested |
| 1 | k | king | king | as requested |
| 2 | k | koala | kitchen | substituted because requested word "koala" is not in Level 2 bank |
| 1 | l | leg | leg | as requested |
...
| 1 | p | pig | pig | as requested |
| 2 | p | pineapple | pineapple | as requested |
| 1 | q | queen | queen | as requested |
| 2 | q | question | question mark | substituted because requested word "question" is not in Level 2 bank |
| 1 | r | red | ring | substituted because requested word "red" is not in Level 1 bank |
| 2 | r | rabbit | rainbow | substituted because requested word "rabbit" is not in Level 2 bank |
| 1 | s | sun | sun | as requested |
| 2 | s | snake | sandwich | substituted because requested word "snake" is not in Level 2 bank |
| 1 | t | tent | tent | as requested |
| 2 | t | tiger | telescope | substituted because requested word "tiger" is not in Level 2 bank |
| 1 | u | up | up | as requested |
| 2 | u | umbrella | unicycle | substituted because requested word "umbrella" is not in Level 2 bank |
| 1 | v | van | van | as requested |
| 2 | v | vegetable | volleyball | substituted because requested word "vegetable" is not in Level 2 bank |
| 1 | w | wig | wig | as requested |
| 2 | w | watch | watermelon | substituted because requested word "watch" is not in Level 2 bank |
| 1 | y | yak | yak | as requested |
| 2 | y | yellow | yogurt cup | substituted because requested word "yellow" is not in Level 2 bank |
| 1 | z | zoo | zoo | as requested |
| 2 | z | zebra | zipline | substituted because requested word "zebra" is not in Level 2 bank |
