...
Generated: 2026-05-28T12:27:05.593Z
...
- CVC Short Vowels:
  ...
  - Raw central-image + answer-image category prompts: gen_cvc_short_a_bad_0_vowel: raw data has central image + 4 image options; renderer suppresses central image, gen_cvc_short_a_bag_1_vowel: raw data has central image + 4 image options; renderer suppresses central image, gen_cvc_short_a_bat_2_vowel: raw data has central image + 4 image options; renderer suppresses central image, gen_cvc_short_a_cap_3_vowel: raw data has central image + 4 image options; renderer suppresses central image, gen_cvc_short_a_fan_4_vowel: raw data has central image + 4 image options; renderer suppresses central image, gen_cvc_short_a_ham_5_vowel: raw data has central image + 4 image options; renderer suppresses central image, gen_cvc_short_a_hat_6_vowel: raw data has central image + 4 image options; renderer suppresses central image, gen_cvc_short_a_jam_7_vowel: raw data has central image + 4 image options; renderer suppresses central image, gen_cvc_short_a_man_8_vowel: raw data has central image + 4 image options; renderer suppresses central image, gen_cvc_short_a_mat_9_vowel: raw data has central image + 4 image options; renderer suppresses central image, gen_cvc_short_a_nap_10_vowel: raw data has central image + 4 image options; renderer suppresses central image, gen_cvc_short_a_pan_11_vowel: raw data has central image + 4 image options; renderer suppresses central image, gen_cvc_short_a_ram_12_vowel: raw data has central image + 4 image options; renderer suppresses central image, gen_cvc_short_a_rat_13_vowel: raw data has central image + 4 image options; renderer suppresses central image, gen_cvc_short_a_tap_14_vowel: raw data has central image + 4 image options; renderer suppresses central image, gen_cvc_short_a_van_15_vowel: raw data has central image + 4 image options; renderer suppresses central image +43 more
