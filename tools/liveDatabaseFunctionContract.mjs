...
export const LIVE_DATABASE_FUNCTIONS = Object.freeze({
  ...
  student_complete_focus_cycle_practice: ["p_token", "p_session_id", "p_attempt"],
  ...
  teacher_start_cycle_practice_session: ["p_class_id", "p_student_ids", "p_assignments", "p_duration_minutes", "p_content_version", "p_whole_class"],
