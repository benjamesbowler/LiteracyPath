...
export const LIVE_DATABASE_FUNCTIONS = Object.freeze({
  ...
  student_get_live_lesson: ["p_token", "p_slide_index", "p_content_ok"],
  student_get_progress: ["p_token"],
  student_complete_maths_assignment: ["p_token", "p_assignment_id"],
  student_report_maths_evidence_sync_health: ["p_token", "p_delivered", "p_pending", "p_rejected"],
  student_report_maths_media_issue: ["p_token", "p_audio_id", "p_reason"],
  student_list_maths_assignments: ["p_token"],
  student_list_press_projects: ["p_token"],
  ...
  student_save_book_revision: ["p_token", "p_project_id", "p_book_id", "p_client_event_id", "p_book", "p_validation"],
  student_submit_book_revision: ["p_token", "p_book_id", "p_revision_id"],
  student_read_class_press_library: ["p_token"],
  student_record_maths_evidence: ["p_token", "p_client_event_id", "p_skill_id", "p_event_type", "p_evidence", "p_occurred_at", "p_content_version"],
  student_submit_live_response: ["p_token", "p_session_id", "p_prompt_id", "p_response", "p_client_event_id"],
  teacher_assign_instructional_group_follow_up: ["p_group_id", "p_owner_label", "p_activity", "p_planned_for"],
  teacher_archive_maths_assignment: ["p_class_id", "p_assignment_id"],
  ...
  teacher_close_worksheet_instance: ["p_instance_id"],
  ...
  teacher_create_maths_assignment: ["p_class_id", "p_skill_id", "p_activity_type", "p_activity_id", "p_title", "p_student_ids", "p_due_at"],
  teacher_create_press_project: ["p_class_id", "p_learner_ids", "p_project_rules"],
  teacher_create_worksheet_instance: ["p_class_id", "p_learner_ids", "p_recipe"],
  ...
  teacher_record_maths_evidence: ["p_class_id", "p_student_id", "p_client_event_id", "p_skill_id", "p_event_type", "p_evidence", "p_occurred_at", "p_content_version"],
  teacher_report_maths_media_issue: ["p_audio_id", "p_reason"],
  ...
  teacher_set_live_lesson_slide: ["p_session_id", "p_slide_index", "p_client_event_id"],
