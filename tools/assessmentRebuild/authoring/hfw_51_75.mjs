...
export default {
  ...
  items: [
    ...
    cz("many", 1, 1, 1, "So ___ children came to the park!", ["many", "one", "two", "all"], [FS, FS, FS],
      "the recorded sentence supplies many; options contrast quantity words"),
    cz("many", 1, 1, 2, "How ___ eggs are in the nest?", ["many", "one", "two", "each"], [FS, FS, DV],
      "natural question with the quantity word many in the recorded sentence"),
    rf("many", 1, 1, 3, ["many", "any", "more", "mane"], [VN, VN, VN]),
    cz("more", 1, 1, 1, "My cup is empty. May I have some ___?", ["more", "one", "each", "all"], [FS, FS, FS],
      "the complete recording supplies more in a familiar everyday context"),
    cz("more", 1, 1, 2, "I read two pages, then read three ___.", ["more", "one", "two", "all"], [FS, FS, FS],
      "the complete recording supplies more in a familiar everyday context"),
    ...
    cz("see", 1, 2, 2, "Use your eyes to ___ my fort.", ["see", "use", "have", "make"], [FS, FS, FS],
      "the named sense organ pins the matching action"),
    rf("see", 1, 2, 3, ["see", "set", "she", "seed"], [VN, VN, VN]),
    ...
    cz("some", 1, 2, 1, "Of eight birds, three sing. ___ birds sing.", ["some", "all", "one", "two"], [FS, FS, FS],
      "three of eight is a stated subset, not all, one or two"),
    cz("some", 1, 2, 2, "I ate ___ of eight slices: exactly three.", ["some", "all", "one", "each"], [FS, FS, FS],
      "exactly three of eight pins some; all, one and each contradict that count"),
    rf("some", 1, 2, 3, ["some", "come", "same", "home"], [VN, VN, VN]),
    ...
    rf("two", 1, 2, 3, ["two", "twin", "who", "tow"], [VN, VN, VN]),
    ...
    cz("would", 1, 2, 1, "___ you like a cup of tea?", ["would", "were", "are", "had"], [FS, FS, DV],
      "the recording supplies would in a familiar offer"),
    cz("would", 1, 2, 2, "Dad said he ___ help us build a den.", ["would", "is", "was", "has"], [DV, DV, DV],
      "the complete recording supplies would in a familiar promise"),
    rf("would", 1, 2, 3, ["would", "could", "wild", "world"], [VN, VN, VN]),
    ...
    rf("write", 1, 2, 3, ["write", "ride", "white", "wrote"], [VN, VN, VN]),
    ...
    cz("many", 1, 1, 7, "How ___ stars can you see tonight?", ["many", "one", "all", "each"], [FS, FS, DV],
      "the recording supplies many in a natural question"),
