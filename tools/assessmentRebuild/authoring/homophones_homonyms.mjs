...
const hcc = (u, lvl, ph, v, sentence, words, rationales, note = "") => ({
  ...
  prompt: sentence,
  spoken: `Which spelling finishes the sentence? ${sentence.replace("___", "hmm")}`,
  sentence,
  choices: words.map((w, i) => (i === 0 ? K(w) : P(w, rationales[i - 1]))),
  media: "text",
  note
...
export default {
  ...
  items: [
    // ================= L1 phase 1 =================
    hm("sea_see", 1, 1, 1, "Which spelling names the big salty water?",
      ["sea", "see", "sand", "say"], [HOM, SEM, VN],
      "salty gifts sa to sand and say — tied distractors, key clean"),
    hm("sea_see", 1, 1, 2, "Which spelling means you look with your eyes?",
    ...
    hm("be_bee", 1, 1, 2, "Which spelling is the doing word in 'Let it ___'?",
      ["be", "bee", "by", "bed"], [HOM, VN, VN]),
    hcc("be_bee", 1, 1, 3, "A ___ landed on the flower.",
    ...
    hcc("no_know", 1, 1, 3, "Dad said ___ when I asked for sweets.",
      ["no", "know", "now", "oops"], [HOM, VN, SEM]),
    hcc("no_know", 1, 1, 4, "Do you ___ the way to school?",
      ["know", "no", "now", "draw"], [HOM, VN, SEM],
      "draw the way parses (a map) and is defensibly not the asked meaning"),
    ...
    hm("ate_eight", 1, 2, 2, "Which spelling tells that lunch is all gone?",
      ["ate", "eight", "eat", "egg"], [HOM, FS, VN],
      "that gifts at to key and eat together — tie"),
    hcc("ate_eight", 1, 2, 3, "Ben ___ all his peas at dinner.",
    ...
    hm("hear_here", 1, 2, 1, "Which spelling uses your ears?",
    ...
    hcc("hear_here", 1, 2, 3, "Shh! I can ___ the owl outside.",
      ["hear", "here", "feed", "name"], [HOM, SEM, SEM],
      "shh pins listening — feeding an owl mid-shh is defensibly wrong"),
    hcc("hear_here", 1, 2, 4, "The bus stops right ___, at this very corner.",
      ["here", "hear", "there", "nearby"], [HOM, SEM, SEM],
      "at this very corner names the speaker's exact spot — there points away and nearby is vague; very and corner gift er to key, there and nearby alike"),

    hm("blue_blew", 1, 2, 1, "Which spelling is the color of the sky?",
    ...
    hcc("to_two_too", 2, 1, 2, "Nan baked ___ pies, one for each hand.",
    ...
    hcc("to_two_too", 2, 1, 3, "That soup is ___ hot to eat!",
      ["too", "to", "two", "very"], [HOM, HOM, SEM],
      "the too-hot-to-eat frame needs too — very hot to eat drops the result meaning"),
    ...
    hcc("right_write", 2, 1, 1, "The teacher ticked it — my sum was ___.",
      ["right", "write", "wrong", "long"], [HOM, "D-OPPOSITE", SEM],
      "ticked pins correct — wrong parses and contradicts the tick; it gifts its chunk to write, a distractor tops"),
    hcc("right_write", 2, 1, 2, "I will ___ a letter to Gran tonight.",
    ...
    hm("right_write", 2, 1, 4, "Which spelling is done with a pencil?",
      ["write", "right", "wrote", "white"], [HOM, FS, VN],
      "with gifts it to key and white together — tie"),

    hcc("new_knew", 2, 1, 1, "My shoes are ___ — I got them today.",
      ["new", "knew", "blue", "wet"], [HOM, SEM, SEM],
      "I got them today explains newness, not color or wetness"),
    ...
    hm("flower_flour", 2, 2, 3, "Which spelling grows in the garden?",
      ["flower", "flour", "floor", "crow"], [HOM, VN, SEM],
      "grows gifts ow to key and crow together — tie; no growing rival like tree"),
    hm("flower_flour", 2, 2, 4, "Which spelling is powder for baking?",
      ["flour", "flower", "floor", "fork"], [HOM, VN, SEM],
      "powder gifts ow to flower and for gifts or to fork — tied distractors"),

    hcc("would_wood", 2, 2, 1, "___ you like some juice?",
      ["Would", "Wood", "Could", "Will"], [HOM, VN, FS],
      "could and will parse — would is the polite offer the frame asks for"),
    ...
    hm("homonym_bat", 2, 1, 1, "A bat can be an animal or a thing for hitting. Which sentence uses bat as the ANIMAL?",
      ["The bat slept upside down in the cave.",
       ...
       "Dad bought a new bat for cricket."], [SEM, SEM, SEM],
      "every sentence carries bat — the shared word ties all four"),
    hm("homonym_bat", 2, 1, 2, "Which sentence uses bat as the thing you HIT with?",
    ...
    hm("homonym_ring", 2, 2, 1, "A ring can be jewelry or a sound. Which sentence uses ring as the SOUND?",
      ["We heard the ring of the doorbell.",
       "Her gold ring sparkled in the sun.",
       "The ring slipped off her finger.",
       "Gran keeps her ring in a tiny box."], [SEM, SEM, SEM]),
    hm("homonym_ring", 2, 2, 2, "Which sentence uses ring as the thing you WEAR?",
    ...
    hm("sun_son", 1, 1, 5, "Which spelling warms the earth?",
    ...
    hm("no_know", 1, 1, 5, "Which spelling fits: I ___ my phone number by heart?",
    ...
    hm("ate_eight", 1, 2, 5, "Which spelling is how many legs an octopus has?",
    ...
    hcc("to_two_too", 2, 1, 5, "It is ___ dark to read outside now.",
      ["too", "to", "two", "so"], [HOM, HOM, SEM],
      "the too-dark-to-read frame needs too — so drops the result meaning"),
    ...
    hcc("right_write", 2, 1, 5, "Use the pencil to ___ your name.",
      ["write", "right", "wrote", "ride"], [HOM, FS, VN]),
    hcc("made_maid", 2, 2, 5, "We ___ a fort out of pillows.",
