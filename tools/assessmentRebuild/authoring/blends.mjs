...
export default {
  ...
  items: [
    ...
    ic("fr", 1, 2, 2, "fruit", ["frog", "flag", "ring", "fish"], "frog",
      { flag: "D-PATTERN-TRAP", ring: "D-ONSET", fish: "D-DEVELOPMENTAL" },
      "fish keeps /f/ but drops the /r/ from the target onset"),
    ...
    // Fresh retention targets include initial and final cluster reductions.
    { ...cw("gr", 1, 2, 20, "grip", "__ip", ["gr", "g", "dr", "sl"]), retention: true,
      choices: [K("gr"), P("g", "D-ONSET"), P("dr", "D-PATTERN-TRAP"), P("sl", "D-PATTERN-TRAP")],
      note: "new gr target; one-letter g drops r, while drip and slip are real competing completions" },
    { ...cw("sw", 1, 2, 20, "sweep", "__eep", ["sw", "w", "sl", "st"]), retention: true,
      choices: [K("sw"), P("w", "D-ONSET"), P("sl", "D-PATTERN-TRAP"), P("st", "D-PATTERN-TRAP")],
      note: "new sw target; weep drops s, and sleep and steep retain different complete blends" },
    { ...cw("sm", 2, 1, 20, "smooth", "__ooth", ["sm", "s", "sp", "sn"]), retention: true,
      choices: [K("sm"), P("s", "D-ONSET"), P("sp", "D-PATTERN-TRAP"), P("sn", "D-PATTERN-TRAP")],
      note: "new spoken adjective supplies a clear sm target without an image-based texture judgement" },
    { ...cw("tr", 2, 1, 20, "track", "__ack", ["tr", "t", "cr", "bl"]), retention: true,
      choices: [K("tr"), P("t", "D-ONSET"), P("cr", "D-PATTERN-TRAP"), P("bl", "D-PATTERN-TRAP")],
      note: "new tr target; tack removes r, while crack and black supply complete competing blends" },
    { ...cw("nt", 2, 2, 20, "hunt", "hu__", ["nt", "n", "mp", "sh"]), retention: true,
      choices: [K("nt"), P("n", "D-DEVELOPMENTAL"), P("mp", "D-PATTERN-TRAP"), P("sh", "D-PATTERN-TRAP")],
      note: "new final nt target; n drops the final stop, while hump and hush are real heard-word rivals" },
    { ...cw("mp", 2, 2, 20, "stump", "stu__", ["mp", "m", "nt", "ck"]), retention: true,
      choices: [K("mp"), P("m", "D-DEVELOPMENTAL"), P("nt", "D-PATTERN-TRAP"), P("ck", "D-PATTERN-TRAP")],
      note: "new final mp target after an initial blend; m drops p, and stunt and stuck supply competing endings" },

    // ================= Retention reserve (form R) =================
    cw("br", 1, 1, 5, "brush", "__ush", ["br", "cr", "fl", "pl"],
      "crush, flush and plush are real; the spoken brush target specifies the intended beginning"),
    cw("br", 1, 1, 6, "broom", "__oom", ["br", "gl", "dr", "sp"],
      "gloom is real; the spoken broom target specifies the intended beginning"),
    ...
    cw("ft", 2, 2, 5, "raft", "ra__", ["ft", "nd", "lt", "sc"],
      "the spoken raft target specifies ft; nd, lt and sc are different endings"),
