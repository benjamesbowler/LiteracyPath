  ...
  items: [
    ...
    it("example_clue", 1, 1, 9,
      ...
      [K("huge beyond belief"),
       ...
       P("very fierce", "D-PLAUSIBLE-UNSUPPORTED")], { retention: true }),
    ...
    it("synonym_clue", 2, 1, 9,
      ...
      [K("extremely hungry"),
       ...
       P("afraid of people", "D-PLAUSIBLE-UNSUPPORTED")], { retention: true }),
    it("synonym_clue", 2, 2, 10,
      ...
      [K("completely puzzled"),
       ...
       P("was solved at once", "D-OPPOSITE")], { retention: true }),
    it("antonym_contrast_clue", 2, 1, 9,
      ...
      [K("calm and peaceful"),
       ...
       P("full of boats", "D-TOPIC-ADJACENT")], { retention: true }),
    it("antonym_contrast_clue", 2, 2, 10,
      ...
      [K("cleverly tricky"),
       ...
       P("missing a piece", "D-PLAUSIBLE-UNSUPPORTED")], { retention: true }),
