...
export default {
  ...
  items: [
    ...
    it("before_after_relation", 2, 1, 1,
      ...
      [K("a drop wrinkled on the cold saucer"),
    ...
    it("before_after_relation", 2, 1, 3,
      ...
      [K("after the mirror showed the back of his head"),
    ...
    it("before_after_relation", 2, 2, 5,
      ...
      [K("after the last frost, in April"),
    ...
    it("process_order", 2, 2, 8,
      ...
      [K("the watering rota keeps them growing all term"),
    ...
    it("before_after_relation", 2, 2, 10,
      ...
      [K("first, while it was still light"),
    ...
    it("implied_order", 2, 1, 10,
      ...
      "Which of these must have happened FIRST?",
      [K("wet sand was packed into the buckets"),
       P("the feather flag went up", "D-SEQUENCE-SWAP"),
       P("the shells were arranged", "D-SEQUENCE-SWAP"),
       P("the tide washed it away", "D-PLAUSIBLE-UNSUPPORTED")], { retention: true }),
    it("implied_order", 2, 2, 11,
      ...
      [K("the chairs were borrowed from next door"),
