...
export default {
  ...
  items: [
    ...
    pis("plural_add_s", 1, 1, 1, "forks", "Which word tells what you see?",
      ["forks", "fork", "books", "book"], [FS, SEM, SEM],
    ...
    psc("plural_add_s", 1, 1, 6, "The three ___ wag their tails.",
      ["dogs", "dog", "hat", "cup"], [FS, SEM, SEM]),
    psc("plural_add_s", 1, 1, 7, "Both ___ lay open on the desk.",
      ["books", "book", "hat", "desk"], [FS, SEM, SEM],
    ...
    psc("plural_add_s", 1, 1, 8, "Six ___ shine over the barn.",
      ["stars", "star", "hat", "dog"], [FS, SEM, SEM],
      "barn gifts ar to stars and star alike"),

    // ================= L1 phase 1: plural_concept =================
    pis("plural_concept", 1, 1, 1, "cat", "Which word matches the picture of one object?",
    ...
    psc("plural_concept", 1, 1, 5, "I see one ___ by the door.",
      ["hen", "hens", "cups", "hats"], [FS, SEM, SEM]),
    psc("plural_concept", 1, 1, 6, "Many ___ twinkle at night.",
      ["stars", "star", "hat", "book"], [FS, SEM, SEM]),
    psc("plural_concept", 1, 1, 7, "One ___ quacks as it floats on the pond.",
      ["duck", "ducks", "frogs", "hats"], [FS, SEM, SEM]),
    psc("plural_concept", 1, 1, 8, "Lots of ___ croak and hop in the grass.",
      ["frogs", "frog", "fish", "hen"], [FS, SEM, SEM]),
    ...
    psc("plural_add_es", 1, 2, 5, "The ___ from dinner included plates and bowls.",
      ["dishes", "dish", "cup", "hat"], [FS, SEM, SEM]),
    psc("plural_add_es", 1, 2, 6, "Three ___ chugged up the hill.",
      ["buses", "bus", "hat", "cat"], [FS, SEM, SEM]),
    psc("plural_add_es", 1, 2, 7, "We used two ___ to scrub our boots.",
      ["brushes", "brush", "fox", "hat"], [FS, SEM, SEM],
      "two requires the plural; the context also pins the object"),
    ...
    psc("plural_irregular", 2, 1, 1, "Three ___ marched in the band.",
      ["men", "man", "tooth", "woman"], [FS, SEM, SEM],
      "three requires a plural, so the singular man and woman choices cannot also fit"),
    psc("plural_irregular", 2, 1, 2, "Both six-year-old ___ lost a baby tooth today.",
      ["children", "child", "hat", "woman"], [FS, SEM, SEM]),
    ...
    psc("plural_f_to_ves", 2, 2, 2, "Three ___ howled on the hill.",
      ["wolves", "wolf", "knife", "shelf"], [FS, SEM, SEM],
      "three requires a plural; howled identifies the animal without offering a second plural noun"),
    psc("plural_f_to_ves", 2, 2, 3, "The chef laid five ___ by the plates.",
      ["knives", "knife", "hat", "shelf"], [FS, SEM, SEM],
    ...
    psc("plural_in_sentence", 2, 2, 1, "All the newborn ___ slept in the dog bed.",
      ["puppies", "puppy", "goose", "plate"], [FS, SEM, SEM],
    ...
    psc("plural_in_sentence", 2, 2, 2, "One ___ was left on the plate.",
      ["peach", "peaches", "loaves", "berries"], [FS, SEM, SEM]),
    psc("plural_in_sentence", 2, 2, 3, "Two ___ of bread sat in the basket.",
      ["loaves", "loaf", "plate", "basket"], [FS, SEM, SEM],
    ...
    ptc("plural_in_sentence", 2, 2, 5, "Which word completes ‘The ___ are ripe’?",
    ...
    ptc("plural_in_sentence", 2, 2, 6, "Which word completes ‘One ___ is barking’?",
      ["dog", "dogs", "cats", "hats"], [FS, SEM, SEM]),

    // ================= Retention reserve (form R) =================
    pis("plural_add_s", 1, 1, 9, "boys", "Pick the word for the picture.",
      ["boys", "boy", "books", "book"], [FS, SEM, SEM]),
    psc("plural_add_s", 1, 1, 10, "Ten ___ bark at the gate.",
      ["dogs", "dog", "moon", "star"], [FS, SEM, SEM]),
    ...
    psc("plural_irregular", 2, 1, 7, "Two white ___ squeaked and nibbled the cheese.",
      ["mice", "mouse", "hat", "man"], [FS, SEM, SEM],
    ...
    psc("plural_f_to_ves", 2, 2, 7, "The baker sliced two ___ for lunch.",
      ["loaves", "loaf", "knife", "plate"], [FS, SEM, SEM]),
