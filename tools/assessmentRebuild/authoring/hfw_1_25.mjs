...
export default {
  ...
  items: [
    ...
    cz("and", 1, 1, 1, "We have jam ___ bread.", ["and", "with", "on", "in"], [FS, FS, FS],
      "every option parses — jam with bread, jam on bread, jam in bread"),
    cz("and", 1, 1, 2, "She has a cat ___ a dog.", ["and", "with", "for", "as"], [FS, FS, FS]),
    ...
    cz("for", 1, 1, 1, "This gift is ___ you.", ["for", "from", "with", "to"], [VN, FS, FS],
      "from is the classic for-confusion and parses perfectly"),
    cz("for", 1, 1, 2, "We ran ___ the bus.", ["for", "from", "at", "of"], [VN, DV, VN]),
    rf("for", 1, 1, 3, ["for", "of", "from", "fog"], [VN, VN, VN]),
    cz("from", 1, 1, 1, "The card is ___ Gran.", ["from", "for", "with", "of"], [VN, FS, VN]),
    cz("from", 1, 1, 2, "He ran back ___ the park.", ["from", "to", "in", "at"], [FS, FS, FS],
    ...
    cz("i", 1, 1, 1, "Mom and ___ bake buns.", ["I", "he", "they", "you"], [FS, FS, FS],
      "every pronoun parses — only the pairing with Mom picks I"),
    cz("i", 1, 1, 2, "May ___ have a go?", ["I", "you", "he", "it"], [FS, FS, FS]),
    ...
    cz("was", 1, 2, 1, "The cat ___ on the bed.", ["was", "is", "saw", "has"], [FS, VN, FS],
      "the blueprint exemplar — saw is the reversal error and every verb parses"),
    cz("was", 1, 2, 2, "The milk ___ cold.", ["was", "is", "be", "saw"], [FS, DV, VN]),
