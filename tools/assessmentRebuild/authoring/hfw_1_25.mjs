...
export default {
  ...
  items: [
    ...
    rf("be", 1, 1, 3, ["be", "by", "bed", "he"], [VN, VN, VN]),
    ...
    cz("is", 1, 2, 1, "Careful! The soup ___ hot.", ["is", "are", "be", "he"], [DV, DV, DV]),
    cz("is", 1, 2, 2, "This cup ___ full of milk.", ["is", "are", "have", "that"], [DV, DV, DV]),
    ...
    rf("to", 1, 2, 3, ["to", "so", "top", "ten"], [VN, VN, VN]),
    cz("was", 1, 2, 1, "Yesterday the pond ___ frozen.", ["was", "is", "are", "his"], [FS, DV, DV]),
    cz("was", 1, 2, 2, "The milk ___ cold when I drank it.", ["was", "is", "be", "that"], [FS, DV, DV]),
    ...
    cz("was", 1, 2, 7, "Yesterday the wind ___ cold.", ["was", "are", "be", "have"], [DV, DV, DV]),
