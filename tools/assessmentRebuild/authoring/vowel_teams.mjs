...
export default {
  ...
  items: [
    ...
    cpsX("oo", 2, 1, 3, "blue", ["moon", "book", "bed", "pig"], "moon",
    ...
    ptdOdd("oo", 2, 1, 6, "oo (as in moon)", ["look", "spoon", "boot", "food"], "look",
      "Distinguish the two oo sounds across four printed words; avoid room and broom, which vary by accent."),
    ...
    cw("ew", 2, 2, 7, "new", "n__", ["ew", "oo", "ow", "oy"],
      "The spoken new distinguishes it from the real now completion; no word card is used."),
    cpsX("aw", 2, 2, 7, "ball", ["straw", "strap", "bin", "leg"], "straw",
      { strap: "D-PATTERN-TRAP", bin: "D-VOWEL", leg: "D-VOWEL" }),
    ptdOdd("oo", 2, 1, 8, "oo (as in moon)", ["good", "moon", "zoo", "food"], "good",
      "Transfer the two oo sounds to a fresh word set with accent-stable long-oo alternatives."),
    cw("aw", 2, 2, 8, "crawl", "cr__l", ["aw", "ow", "ee", "oo"],
      "The heard crawl pins aw; creel is a different real word, not another spelling of crawl."),
    cw("ay", 1, 1, 11, "spray", "spr__", ["ay", "ai", "ee", "oa"],
      "A new final-ay word distinguishes the conventional ending from a medial-ai spelling."),
    cw("ee", 1, 1, 11, "sweet", "sw__t", ["ee", "ea", "ai", "oa"],
      "The heard sweet distinguishes it from the real short-vowel sweat completion."),
    cw("igh", 1, 2, 11, "sight", "s__t", ["igh", "ai", "ee", "oa"],
      "Transfer the three-letter team to a new target; every option is a taught team."),
    cw("oo", 2, 1, 9, "stood", "st__d", ["oo", "ou", "oa", "ee"],
      "A fresh short-oo word balances the reserve’s existing long-oo and contrast questions.")
  ].map(item => {
