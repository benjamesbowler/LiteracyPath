...
export default {
  ...
  items: [
    ...
    gic("synonym_concrete", 1, 1, 3, "small", "Which word means about the same as small?",
    ...
    wiss("synonym_in_context", 2, 2, 1, "Dad fixed the gate. Dad also ___ the fence.",
    ...
    gic("antonym_concrete", 1, 1, 7, "full", "What is the opposite of full?",
