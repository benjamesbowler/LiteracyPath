...
export default {
  ...
  items: [
    ...
    rcp("ir", 2, 2, 7, "skirt", "sk__t", ["ir", "ur", "er", "or"],
      "Fresh skirt replaces a repeat of ordinary first; all three same-sound spellings compete."),
    rcp("ur", 2, 2, 7, "church", "ch__ch", ["ur", "er", "ir", "or"],
      "Fresh church tests ur between two consonant digraphs without repeating the nurse target."),
    ...
    rcp("ir", 1, 2, 11, "dirty", "d__ty", ["ir", "er", "ur", "or"],
      "A familiar describing word extends ir beyond the ordinary concrete nouns."),
    rcp("er", 1, 2, 8, "ladder", "ladd__", ["er", "ir", "ur", "ar"],
      "A familiar new target uses final unstressed er; the complete recording pins the word."),
    rcp("ar", 2, 1, 15, "harvest", "h__vest", ["ar", "or", "er", "ur"],
      "Transfer ar into the first syllable of a new two-syllable word."),
    rcp("or", 2, 1, 15, "airport", "airp__t", ["or", "ar", "er", "ur"],
      "The blank assesses or in port; the other vowel spelling stays outside the scored gap."),
    rcp("er", 2, 2, 11, "supper", "supp__", ["er", "ir", "ur", "ar"],
      "Choose conventional final er against both same-sound spelling rivals."),
    rcp("ir", 2, 2, 11, "birthday", "b__thday", ["ir", "er", "ur", "ar"],
      "A new compound requires ir in its first part, with same-sound rivals still available."),
  ].map(item => {
