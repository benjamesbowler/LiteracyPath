...
const qualityReplacementRows = [
  ...
  [
    ...
    "Create a clear, natural-colored piece of chewing gum or pack of gum on a clean white/simple background. No face, no eyes, no smile, no rainbow colors, no sparkles, no text, no labels, no watermark.",
    "Current image is babyfied with a face/decorative styling. Non-living objects must not have faces."
  ],
  [
    "Initial Sounds",
    1,
    ...
    "Create one clear, natural-colored cartoon hat on a clean white/simple background. No face, no eyes, no smile, no sparkles, no confetti, no text, no labels, no watermark.",
    "Current image is babyfied with a face/decorative shapes. Non-living objects must not have faces."
  ],
  [
    "Initial Sounds",
    1,
    ...
    "Create one clear jar of strawberry jam on a clean white/simple background. Natural red jam color, no face, no eyes, no smile, no sparkles, no embedded text, no labels, no watermark.",
    "Current image is babyfied with a face. Non-living food/object targets must not have faces."
  ],
  [
    "Initial Sounds",
    1,
    ...
    "Create one clear, natural cartoon human leg from knee to foot, neutral skin tone, simple shoe optional, clean white/simple background. No face, no eyes, no smile, no sparkles, no text, no labels, no watermark.",
    "Current image is babyfied with a face. Body-part targets should be natural and clear, not character objects."
  ],
  [
    "Initial Sounds",
    1,
    ...
    "Create one clear natural yellow sun icon/cartoon on a clean white/simple sky background. No face, no sunglasses, no eyes, no smile, no rainbow colors, no sparkles, no text, no labels, no watermark.",
    "Current image is babyfied with sunglasses/face. Non-living nature/object targets must not have faces."
  ],
  [
    "Initial Sounds",
    1,
    ...
    "Create one clear natural-colored wig on a simple wig stand or plain background. No face, no eyes, no smile, no rainbow colors, no sparkles, no text, no labels, no watermark.",
    "Current image is babyfied with a face/rainbow styling. Non-living objects must not have faces."
  ]
