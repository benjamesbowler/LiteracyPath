...
const report = [
  ...
  "## Current Policy",
  "",
  "Guided Reading now allows approved nonfiction books plus the Bob and Nan Level A, James and Anna Level B, and Aiden and Betty Level C fiction teacher-preview series. Bob and Nan now includes Level A books 1-10. Old deleted fiction and public-domain books must remain off the readable shelf.",
  "",
