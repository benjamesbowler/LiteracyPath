-- Reassert the complete database API boundary after assessment-question
-- reporting. PostgreSQL grants EXECUTE on new functions to PUBLIC by default,
-- so the last SECURITY DEFINER migration revokes every role first and restores
